      ...
      >
        <View style={styles.headerRow}>
          ...
          <View>
            ...
            >
              Configure your chat experience and interface settings
            </Text>
          </View>
        </View>
          ...
          rows={[
            {
              ...
              title: "Notifications",
              text: "Push notifications are currently disabled for the MVP phase.",
            },
            {
              icon: "trash-outline",
              title: "History Management",
              text: "Chat history can be cleared on a per-conversation basis from the history tab.",
            },
            {
              icon: "text-outline",
              title: "Text size",
              text: "The application scales dynamically with your device's native accessibility settings.",
            },
          ]}
        />
