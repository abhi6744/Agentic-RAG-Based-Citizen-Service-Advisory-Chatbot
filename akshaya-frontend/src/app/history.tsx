...
const filters: { label: string; value: Category }[] = [
  { label: "All", value: "all" },
  { label: "Aadhaar", value: "aadhaar_update" },
  { label: "Ration Card", value: "documents" },
  { label: "Scholarship", value: "documents" },
];
...
export default function HistoryScreen() {
  ...
  useEffect(() => {
    async function fetchHistory() {
      try {
        const response = await fetch(`${API_URL}/conversations?device_id=default`);
    ...
    >
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View>
            ...
            <View style={styles.filterHeader}>
              ...
              >
                {visibleConversations.length} saved
              </Text>
            </View>
        ...
        ListEmptyComponent={
          <EmptyHistory
            colors={colors}
            filtered={search.length > 0 || selectedFilter !== "all"}
