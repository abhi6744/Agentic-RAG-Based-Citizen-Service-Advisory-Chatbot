    ...
    >
      ...
      >
          ...
          rows={[
            {
              ...
              text: "Do not enter Aadhaar numbers, OTPs, biometric details, document images, passwords, or bank information in chat.",
            },
            {
        ...
        >
          ...
          <View style={styles.fixedThemeTextArea}>
            <Text
              style={[
                styles.fixedThemeTitle,
                {
                  color: colors.primaryDark,
                },
              ]}
            >
              Green and white interface
            </Text>

            <Text
              style={[
                styles.fixedThemeText,
                {
                  color: colors.primaryDark,
                },
              ]}
            >
              This application uses one clear, high-contrast green and white
              visual style for consistency and readability.
            </Text>
          </View>
        </View>
