...
This report presents the problem definition, theoretical background, requirements, system architecture, software design, cloud integration, dashboard design, algorithms, implementation, deployment process, testing methodology, results, limitations, responsible use of AI and future scope."""
    for p in abs_text.split('\n\n'):
        story.append(Paragraph(p.replace('—', '-').replace('–', '-'), normal))
    story.append(PageBreak())
    ...
    toc_data = [
        ...
        ["1.6 Scope", "2"],
        ["1.7 Contributions", "2"],
        ["Chapter 2 - System Study & Theoretical Background", "3"],
        ["2.1 Existing Approaches", "3"],
        ["2.2 Retrieval-Augmented Generation (RAG)", "3"],
        ["2.3 Large Language Models (LLMs)", "3"],
        ["2.4 Multilingual Natural Language Processing", "3"],
        ["2.5 Web Dashboards and UI", "4"],
        ["2.6 Trust and Citation Mechanisms", "4"],
        ["2.7 Cloud-Native Design Perspective", "4"],
        ["2.8 Requirement Analysis", "4"],
        ["Chapter 3 - System Design & Implementation", "6"],
        ["3.1 Roles and Responsibilities", "6"],
        ["3.2 Tools and Technologies", "6"],
        ["3.3 Overall System Architecture", "6"],
        ["3.4 Use Case Model", "6"],
        ["3.5 Data Flow Design", "6"],
        ["3.6 Process Flow", "7"],
        ["3.7 Activity and State Behaviour", "7"],
        ["3.8 Software Design", "7"],
        ["3.9 Data Model", "7"],
        ["3.10 Dashboard Design", "7"],
        ["3.11 Algorithms", "7"],
        ["3.12 Implementation", "7"],
        ["Chapter 4 - Deployment, Testing, Results & Discussion", "8"],
        ["4.1 Deployment Strategy", "8"],
        ["4.2 Functional Testing", "8"],
        ["4.3 Backend Testing", "8"],
        ["4.4 Frontend Testing", "9"],
        ["4.5 Integration Testing", "9"],
        ["4.6 Testing Workflow", "9"],
        ["4.7 Results: Implemented Functionalities", "9"],
        ["4.8 Results: Retrieval and Generation", "9"],
        ["4.9 Feature Analysis", "9"],
        ["4.10 Challenges and Resolutions", "10"],
        ["4.11 Deployment Readiness", "10"],
        ["Chapter 5 - Conclusions & Recommendations", "11"],
        ["5.1 Summary of Work", "11"],
        ["5.2 Learning Outcomes", "11"],
        ["5.3 Limitations", "11"],
        ["5.4 Responsible Usage of AI", "11"],
        ["5.5 Future Scope", "12"],
        ["5.6 Recommendations", "12"],
        ["5.7 Conclusion", "12"],
        ["References", "13"],
        ["Appendix A - API Configuration", "14"],
        ["Appendix B - Database Schema", "14"],
        ["Appendix C - Mermaid Diagram Source", "14"],
        ["Appendix D - Project Screenshots", "14"],
        ["Appendix E - Source Code", "15"]
    ]
    ...
    # Make chapter rows bold inside the table
    for i, row in enumerate(toc_data):
        if "Chapter" in row[0] or row[0] in ["Abstract", "List of Tables", "List of Figures", "List of Abbreviations", "References", "Appendix A - API Configuration", "Appendix B - Database Schema", "Appendix C - Mermaid Diagram Source", "Appendix D - Project Screenshots", "Appendix E - Source Code"]:
    ...
    for r in refs:
        story.append(Paragraph(r.replace('—', '-').replace('–', '-'), normal))
    story.append(PageBreak())
